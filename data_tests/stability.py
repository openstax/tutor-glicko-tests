...
glicko_batch.fit(df[['student', 'question', 'score']])
df_item = df.copy()[['student', 'rating_1']].drop_duplicates().rename(columns={'student': 'entity', 'rating_1': 'rating_true'})
df_item = df_item.merge(glicko_batch.df_entities[['entity', 'rating']].rename(columns={'rating': 'rating_batch'}))
...
ggsave(plot=fig_sigma_density, filename='sigma_density.png', dpi=1000)
ggsave(plot=fig_tau_density, filename='tau_density.png', dpi=1000)
